...
- Sem repetições: Um mesmo número não pode aparecer mais de uma vez em uma mesma linha, coluna ou bloco. - Objetivo: O jogo termina quando toda a grade está completamente preenchida, seguindo todas as regras.
